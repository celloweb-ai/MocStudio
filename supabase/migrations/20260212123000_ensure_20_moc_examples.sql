...
BEGIN
  ...
  FOR rec IN
    ...
    FROM (
      VALUES
        ...
        ('FAC-PAD','Install Dust Extraction Booster on Bagging Line','Increase extraction airflow at bagging hoppers.','Dust accumulation is triggering housekeeping observations.','equipment_addition','medium','submitted',false,'8 days',ARRAY['Bagging line','Dust collection'],ARRAY['Bagging hall'],2,3,'medium','Balance airflow and verify noise compliance after startup.',false,12,9,'Dust Booster Fan DBF-02'),
  ...
  RAISE NOTICE 'MOC/asset example ensure complete. Inserted % missing records.', v_inserted_count;
END;
$$;
